...
e = this, t = function (e) {
        ...
        ge = e => {
            ...
            if (n.Fe) n.Pe = E(r), L(n.Pe, 'body'); else {
                ...
                j(e, 'pm-overlay'), V(n.Fe, e), B(e, f, a), n.we = E(r), j(n.we, 'pm'), A(n.we, 'role', 'dialog'), A(n.we, l, !0), A(n.we, 'aria-modal', !0), A(n.we, 'aria-labelledby', 'pm__title'), B(n.ye, 'keydown', (e => {
                    27 === e.keyCode && a()
                }), !0), n.Oe = E(r), L(n.Oe, 'header'), n.Re = E('span'), L(n.Re, 'title'), n.Re.id = 'pm__title', n.Be = E(i), L(n.Be, 'close-btn'), A(n.Be, 'aria-label', g.closeIconLabel || ''), B(n.Be, f, a), n.$e = E('span'), n.$e.innerHTML = X(), V(n.Be, n.$e), n.Ge = E(r), L(n.Ge, 'body'), n.Je = E(r), L(n.Je, 'footer');
                var D = E(r);
                j(D, 'btns');
                var k = E(r), N = E(r);
    ...
    const ye = () => {
        ...
        w && (n.Ze || (n.Ze = E('span'), n.Ze.className = n.Ze.id = 'cm__title', V(n.Xe, n.Ze)), n.Ze.innerHTML = w);
        let x = p.description;
